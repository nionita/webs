...
from app.auth.forms import LoginForm, RegistrationForm, ResetPwdReqForm, ResetPasswordForm
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.login'))
    return render_template('auth/reset_pwd_req.html', title=_('Reset Password'), form=form)
